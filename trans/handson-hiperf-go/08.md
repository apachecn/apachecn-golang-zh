...
![](assets/81bdfc69-6487-4960-8314-6bbc1befb46f.png)
...
![](assets/9c6365c0-e7b8-4ad6-b012-156776750b96.png)
...
![](assets/e368c05e-61a4-4f07-9d92-e6bfca7f7bc0.png)

我们还可以使用其他 Linux 工具来研究这些 ELF 二进制文件。`readelf`还将以更易于阅读的格式打印 ELF 文件。例如，我们可以按如下方式查看 ELF 文件：

![](assets/0fe039dc-bb91-46ab-b5a0-0f9faaa1b30a.png)
...
![](assets/642fb06a-a721-41ab-b51d-4db166d02b1d.png)

正如您在结果输出中所看到的，这个特定的二进制文件是为 i386 处理器生成的，而不是最初生成的 x86_64 二进制文件：

![](assets/5f2a3cba-31df-4636-a91e-44c3e442cc8e.png)
...
![](assets/31678bb4-b5a6-4c78-816d-646eeb49a4e3.png)
...
![](assets/bb8813d9-27e7-4f36-bb82-d4cebcbae446.png)
...
![](assets/d1ab7fe3-9ab0-4a0a-8aca-c6c2e7035bf3.png)
...
![](assets/b113544c-1739-46b6-9cca-8d0ea15c940f.png)
...
![](assets/87c357c5-4297-4f02-953d-411fd51fd370.png)
...
![](assets/a3278b05-e735-4544-8fac-6ece827fc174.png)

我们可以看到`net/http`库占用了大量空间，运行时和网络库也占用了大量空间。

相比之下，让我们看一下我们的简单程序，其中包含内存统计信息：

![](assets/84587793-0388-4e30-8053-78dd733cfaa8.png)
...
![](assets/15f01d58-f40a-4f5d-80d6-a17a17d9a441.png)

我们的简单程序示例如下所示：

![](assets/a1797f59-dcb9-477d-a3c9-43d4761f5a36.png)
...
![](assets/0c5071fb-8149-4b4a-ba74-c152eff4e528.png)
...
![](assets/456eb523-f097-49dc-9674-28140e57c054.png)
