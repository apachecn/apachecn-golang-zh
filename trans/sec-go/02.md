...
![](assets/d5514c8a-7253-4641-8b61-3e02ebcac15e.png)
...
![](assets/155646d8-315b-4b13-aa31-c7be08feb713.png)
...
双引号用于字符串。单引号仅用于单个字符或符文，而不是字符串。字符串可以通过 declare 和 assign 操作符使用长格式或短格式定义。您还可以使用```（反勾号）符号来封装跨多行的字符串。下面是字符串用法的一个简短示例：
