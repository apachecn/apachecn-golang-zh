...
![](../Images/a8ba339a-0300-4012-8a27-280779c6fc81.png)
...
![](../Images/3164bd3c-f56b-47f9-a36d-43f5ca76cd34.png)

#### 老板-工人模式

在 boss-worker 模式中，**boss**过滤器将数据向下推送到处理数据的工作人员，并将结果合并到**产品**：

![](../Images/4e2256fb-62d4-484e-a677-2699938dbd25.png)

#### 负载平衡器

下面的示例显示了一个**负载平衡器**，它接收来自客户端的请求，并将它们发送到积压最少且最有可能处理请求信息包的服务器：

![](../Images/641536af-3cf2-4026-8356-fffa971bad36.png)
...
| **过滤器类型** | **图像** | **接收** | **发送** | **说明** |
| **读** | ![](../Images/581df9d3-ea69-4bba-b5fd-98816201ed16.png) |  | ![](../Images/e065c36e-7b8c-472b-b2df-22c69774644d.png) | **读取**过滤器从数据源读取数据，并将信息包发送到下游。 |
| **拆分** | ![](../Images/beb61560-0dff-4ba2-9537-2ed634a6c356.png) | ![](../Images/e065c36e-7b8c-472b-b2df-22c69774644d.png) | ![](../Images/e065c36e-7b8c-472b-b2df-22c69774644d.png)![](../Images/e065c36e-7b8c-472b-b2df-22c69774644d.png) | 从同一通道读取多个函数，直到该通道关闭。它通过在一组工作人员之间分配工作以并行化 CPU 使用来提高性能。 |
| **变换** | ![](../Images/906ea89c-b1e8-400a-9abf-f37907bf6d16.png) | ![](../Images/e065c36e-7b8c-472b-b2df-22c69774644d.png) | ![](../Images/e065c36e-7b8c-472b-b2df-22c69774644d.png) | 此筛选器从上游接收数据，对其进行转换，然后将其发送到下游。 |
| **合并** | ![](../Images/b3515be9-b909-4b4a-a4bd-f256d0697213.png) | ![](../Images/e065c36e-7b8c-472b-b2df-22c69774644d.png)![](../Images/e065c36e-7b8c-472b-b2df-22c69774644d.png) | ![](../Images/e065c36e-7b8c-472b-b2df-22c69774644d.png) | 此函数从多个输入通道读取到单个通道，当所有输入关闭时，该通道关闭。工作可以分配到多个 goroutine，这些 goroutine 都从同一个输入通道读取。 |
| **写入** | ![](../Images/9f22ce75-8545-450e-a029-0f3e09e1cb25.png) | ![](../Images/e065c36e-7b8c-472b-b2df-22c69774644d.png) |  | 此筛选器从上游接收数据并将其写入接收器。 |

##### 积木

这些是基于流的编程系统的基本构建块。通过这些基本操作，我们可以构建任何基于组件的系统：

![](../Images/8b2a5616-80dd-4653-b1e9-cc4658fbf4c1.png)
...
![](../Images/74baa648-b3ea-4ec7-9eb3-ac89c57c0342.png)
...
![](../Images/ae1c9d2f-d295-494b-8b17-ad4d5d8c8567.png)
...
![](../Images/9ddbc0de-b007-4794-ab6b-88901d9a9605.png)
...
![](../Images/050180d4-ba4a-40a3-bc59-4d2f2f328d4e.png)
...
![](../Images/524bf1d3-8f54-4431-acd1-da49e4472a9b.png)
