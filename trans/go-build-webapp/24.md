...
![Using concurrency to attack C10K](graphics/3483OS_06_01.jpg)
...
![Taking another approach](graphics/3483OS_06_02.jpg)
...
![Benchmarking against a blocking web server](graphics/3483OS_06_03.jpg)
...
![Handling requests](graphics/3483OS_06_04.jpg)
...
![Handling requests](graphics/3483OS_06_05.jpg)
...
![Serving pages](graphics/3483OS_06_06.jpg)

怎么样？不仅没有额外的开销，而且文件服务器功能本身似乎比独特的`FileServe()`调用更重、更慢。为什么呢？在其他原因中，没有显式地调用文件来打开和服务会带来额外的操作系统调用，这种调用可以在请求装载时级联，以牺牲并发性和性能为代价。
...
![Parsing our template](graphics/3483OS_06_09.jpg)
...
![Connecting to MySQL](graphics/3483OS_06_10.jpg)
...
![Multithreading and leveraging multiple cores](graphics/3483OS_06_11.jpg)
...
![Timing out and moving on](graphics/3483OS_06_12.jpg)
