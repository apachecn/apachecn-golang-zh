...
![Designing the web server plan](img/3483OS_02_01.jpg)

在这里，您需要创建一个名为`GOPATH`的新变量。和 Linux 和 Mac 指令一样，这可以是您的 Go 语言根目录，也可以是其他完全不同的地方。在本例中，我们使用了`C:\Go`，如以下屏幕截图所示：

![Designing the web server plan](img/3483OS_02_02.jpg)
...
![Visualizing concurrency](img/3483OS_02_03.jpg)
...
![Visualizing concurrency](img/3483OS_02_04.jpg)
...
![Visualizing concurrency](img/3483OS_02_05.jpg)
...
![An RSS reader with self diagnostics](img/3483OS_02_06.jpg)
...
![The dining philosophers problem](img/3483OS_02_07.jpg)
