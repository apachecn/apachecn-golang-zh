...
![](assets/a8194ce7-d255-4723-b99f-c570e1fdeb92.png)
...
![](assets/edc1967e-3c91-4b9e-ae04-4f85abd4cb87.png)

# 它是如何工作的…

命令成功执行后，web 应用程序将在默认的 Beego 端口`8080`上运行，浏览`http://localhost:8080/`将呈现应用程序的欢迎页面，如下图所示：

![](assets/34d6133d-8cb1-476f-af60-3dccfa850c63.png)

# 创建第一个控制器和路由器

web 应用程序的主要组件之一是控制器，它充当视图和模型之间的协调器，并处理用户的请求，这些请求可以是按钮单击、菜单选择或 HTTP`GET`和`POST`请求。在本食谱中，我们将学习如何在 Beego 中创建控制器。
...
![](assets/bb36f8f2-6852-4f28-8e3f-6778731ecb60.png)
...
![](assets/6ddd6d86-c388-4b8b-bcb9-bb0a801be17d.png)
...
![](assets/5f17dd63-8b1e-4118-a2fa-686a57917a47.png)
...
![](assets/46d2b6f4-a78c-46ce-b33c-653bf5346abe.png)

鉴于浏览`http://localhost:8080/employee?id=4`如下：

![](assets/15fa193a-8f0a-4154-b574-38c885b00a10.png)
 ...
 **![](assets/35ad2340-26fa-41f7-9b3b-dd7c9c2d5056.png)
...
![](assets/c53d95cd-edbc-432a-b968-96b5e9211ce8.png)

浏览`http://localhost:8088/qps`会显示一个应用的请求统计信息，如下图所示：

![](assets/b9affdd6-bf38-4319-8855-584efdaf1be2.png)
...
![](assets/4d67d510-d668-4788-b5fe-53b2f4d307bb.png)
...
![](assets/9ca23b43-cd30-4fb7-8c77-33a1e83f9530.png)**