...
![](assets/ab60eb27-0295-4b8a-9c7b-9d85f6c65b55.png)
...
![](assets/f54a702f-1181-404b-8c55-f0502b2365fb.png)
...
![](assets/5125ff70-60b0-4b27-a291-1fd30a424f85.png)
...
![](assets/94798377-1729-4559-9e5c-6c4ca2fa2f59.png)
...
![](assets/07fd3f5a-f8c5-4976-98b3-5527c8372755.png)
...
![](assets/f2ba4915-2e5d-4d3e-a893-eab0364df5d8.png)
...
![](assets/b9fbfd8c-a74f-4b47-a3b3-4ac7c8ebacf3.png)
...
![](assets/7d973921-5f28-483f-b58d-77ac105575c0.png)
...
![](assets/b576b702-a85a-4b85-8f84-6107c72022bb.png)

输入用户名和密码并单击登录按钮后，我们将看到 Hello 后面跟着用户名作为服务器的响应，如以下屏幕截图所示：

![](assets/f0373bdf-58fd-4108-8adf-24e204ff3006.png)
...
![](assets/348772a2-efa6-4d10-85b0-7c8862333408.png)

然后提交包含有效值的表单：

![](assets/86cba772-9979-4efc-ace2-bae92d5497be.png)

它将在浏览器屏幕上显示 Hello，后跟用户名，如以下屏幕截图所示：

![](assets/12b1c3c6-f8d8-412e-96a3-b29e20e7d229.png)

在任何字段中提交值为非 alpha 的表单都会显示错误消息。例如，提交用户名值为`1234`的表单：

![](assets/11bbc899-37d9-4d63-8edf-d38a2a63de20.png)

它将在浏览器上向我们显示一条错误消息，如以下屏幕截图所示：

![](assets/2e669f3e-942c-42e1-9c2c-d7ee4b674cf6.png)
...
![](assets/2ad63a7c-1b4b-468d-9dea-3fa04157ba04.png)
...
![](assets/670f25ff-f46e-4aec-b0b4-c150b76ba734.png)
...
![](assets/db929449-393f-4fa5-92ff-368b6c2f5de0.png)

选择文件后按 Submit 按钮将在服务器上创建一个名为`uploadedFile`的文件，该文件位于`/tmp`目录中。通过执行以下命令可以看到这一点：

**![](assets/438fac80-0552-4137-b28f-d6efe696fbfe.png)**

此外，成功上载将在浏览器上显示消息，如以下屏幕截图所示：

![](assets/d430fc2d-02ab-4941-86c2-52dccd992090.png)
