...
![](assets/d9602a30-7f26-4d7d-a22e-e2e5a3a1dada.png)

接下来，在下一个示例中为表指定一个名称，如`movies`。。由于每个电影都将由一个唯一的 ID 标识，因此它将是表的分区键。将所有其他设置保留为默认状态，然后点击 Create，如下所示：

![](assets/778d260b-e9d9-469a-a2d0-79fae4b4f2a2.png)

创建表时请等待几秒钟，如下所示：

![](assets/ffd40dce-59bf-4d91-bfba-26dcce344897.png)
...
![](assets/2b88f35a-8d5b-4991-84e8-3144f45c3fd1.png)

然后，点击**创建项目**并插入一部新电影，如下图所示（您需要使用加号（+）按钮附加一列以存储电影名称）：

![](assets/40c329da-cd7a-41f7-b4be-670ee9a36e31.png)

点击保存。该表应如下所示：

![](assets/ebb6530d-ff25-41fa-98f7-4fc7e45d3f40.png)
...
![](assets/729f5fbc-9820-4ce3-9161-521ce3eb2bac.png)
...
![](assets/ca81f50b-4e81-4c21-9871-6cd97eeabfc6.png)
...
![](assets/ec5e0848-c799-4198-9587-0907f2458486.png)
...
![](assets/90ddc595-42c2-4356-89a7-4a0441a012e8.png)
...
![](assets/9970ba6a-ebfe-4d8c-96f5-fcb677345e48.png)
...
![](assets/af479fe5-73a7-486c-8dc9-b5f69ad75fa6.png)
...
![](assets/97c1e2d9-b691-4661-a10f-b6603de50f75.png)
...
![](assets/b12ebdf3-11f4-4db8-85be-586c46979aea.png)
...
![](assets/9d7a8cf7-359c-48f7-afbe-119c70506adc.png)
...
![](assets/342056fe-729b-4b4f-9115-b6ac94d5c117.png)
...
![](assets/6605624f-7263-42fd-a746-d0280410f375.png)
...
![](assets/b7eea63f-4d13-4f9b-bdad-0b0f642b0db7.png)
...
![](assets/d1e275f0-c10e-44ae-a39f-b14a9ea600ae.png)
...
![](assets/b12c59b9-b5c5-425a-a3d3-7216bbcfb7a4.png)
...
![](assets/7b7ca496-3ee9-4be8-8099-47156c0478fe.png)
...
![](assets/939137cb-caec-46a0-8461-1dd68979dd39.png)
...
![](assets/28a1ef22-904e-4f87-aabf-053d9ef08d44.png)
...
![](assets/3bea6331-a823-476e-a529-21f264eefb6e.png)
